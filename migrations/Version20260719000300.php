...
final class Version20260719000300 extends AbstractMigration
{
    ...
    {
        return 'M1.9.4 hardens one standard accounting set per play and binds ledger entries to the owning STANDARD play.';
    }
...
SQL);
    ...
    {
        $this->addSql('DROP TRIGGER trg_ledger_standard_entry_play_binding');
        $this->addSql('DROP INDEX uniq_standard_organizer_share_per_play');
        $this->addSql('DROP INDEX uniq_standard_jackpot_contribution_per_play');
        $this->addSql('DROP INDEX uniq_standard_player_entry_per_play');
    }
}
