...
final class WinningSettlementGateVerifierTest extends KernelTestCase
{
    public function testGatePassesAndRollsBackSuccessfulAndFaultedSettlementScenarios(): void
    {
        self::bootKernel();
        ...
        $report = self::getContainer()->get(WinningSettlementGateVerifier::class)->verify();
